...
/* import 'package:oilappadmin/Screens/Vehicles/view_image.dart';
import 'package:oilappadmin/Screens/home_screen.dart';
import 'package:oilappadmin/Screens/ourservice/backend_carnoteservice.dart'; */
import 'package:oilappadmin/config/config.dart';
import 'package:oilappadmin/screens/carNotes.dart';
import 'package:oilappadmin/screens/view_image.dart';
import 'package:oilappadmin/services/backend_carnoteservice.dart';
...
class EditCarNote extends StatefulWidget {
  ...
  const EditCarNote({super.key, required this.noteCar, required this.vehicleModel, required this.attachmentsFromDB, required this.userModel});
          ...
          actions:(selectingAttachments)? <Widget>[
            ...
            IconButton(
              ...
              onPressed: () async {
                ...
                Route route = MaterialPageRoute(builder: (_) =>  CarNotes(
