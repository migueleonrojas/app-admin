...
import 'package:oilappadmin/services/address_service.dart';
import 'package:oilappadmin/widgets/mytextFormfield.dart';
import 'package:oilappadmin/widgets/noInternetConnectionAlertDialog.dart';
import 'package:oilappadmin/widgets/simpleAppbar.dart';

import '../widgets/erroralertdialog.dart';
class EditAddress extends StatefulWidget {

  final UserAddressModel addressModelEdit;

  final String userId;

  const EditAddress({super.key, required this.addressModelEdit, required this.userId});
...
class _EditAddressState extends State<EditAddress> {
  ...
  void initState() {
    ...
    cameraPosition =  CameraPosition(
      target: LatLng(
        widget.addressModelEdit.latitude!,
        widget.addressModelEdit.longitude!
      ),
      zoom: 18
    );
    _markers.add(
  ...
  cName.text = widget.addressModelEdit.customerName!;

  cPhoneNumber.text = widget.addressModelEdit.phoneNumber!;

  cHouseandRoadNumber.text = widget.addressModelEdit.houseandroadno!;

  cCity.text = widget.addressModelEdit.city!;

  cArea.text = widget.addressModelEdit.area!;

  cAreaCode.text = widget.addressModelEdit.areacode!;
                          ...
                          onPressed: () async {
                            ...
                            if (cName.text.isNotEmpty &&
                              ...
                              _addressService.updateAddress(
                                ...
                                widget.addressModelEdit.addressId!,
                                widget.userId
                              );
